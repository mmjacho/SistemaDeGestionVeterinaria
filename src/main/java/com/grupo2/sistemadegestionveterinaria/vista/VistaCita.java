...
public class VistaCita extends JFrame {
  ...
  public VistaCita() {
    ...
    panelCentro.add(new JLabel("Seleccione Médico:"));
    cbxMedico = new JComboBox<>(new String[]{"(Seleccione un médico)"});
    panelCentro.add(cbxMedico);
    panelCentro.add(new JLabel("Seleccione Mascota:"));
    cbxMascota = new JComboBox<>(new String[]{"(Seleccione una mascota)"});
    panelCentro.add(cbxMascota);
    panelCentro.add(new JLabel("Fecha (DD/MM/YYYY):"));
    txtFecha = new JTextField();
    panelCentro.add(txtFecha);
    panelCentro.add(new JLabel("Hora (HH:MM):"));
    ...
    panelSur.add(btnAgendar);
    panelSur.add(btnBuscar);
    panelSur.add(btnReprogramar);
